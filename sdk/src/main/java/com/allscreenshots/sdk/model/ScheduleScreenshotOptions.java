...
/**
 * Screenshot options for scheduled screenshots.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ScheduleScreenshotOptions {
    ...
    public ScheduleScreenshotOptions() {
    }

    private ScheduleScreenshotOptions(Builder builder) {
    ...
    public static class Builder {
        ...
        public ScheduleScreenshotOptions build() {
            return new ScheduleScreenshotOptions(this);
        }
    }
}
