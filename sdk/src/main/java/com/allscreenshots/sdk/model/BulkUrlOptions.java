...
/**
 * Options for a single URL in a bulk screenshot request.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class BulkUrlOptions {
    ...
    public BulkUrlOptions() {
    }

    private BulkUrlOptions(Builder builder) {
    ...
    public static class Builder {
        ...
        public BulkUrlOptions build() {
            return new BulkUrlOptions(this);
        }
    }
}
